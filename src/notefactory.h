...
Note* createNoteLauncher(const QString    &url,      BasketScene *parent);
...
Note* copyFileAndLoad(const QString &file,         BasketScene *parent);
Note* moveFileAndLoad(const QString &file,         BasketScene *parent);
